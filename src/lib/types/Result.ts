...
export type Result<RESULT_TYPE, ERROR> = Result.Ok<RESULT_TYPE, ERROR> | Result.Err<RESULT_TYPE, ERROR>;

export declare namespace Result {
    /**
     * @internal
     * */
    export interface _Result<DATA, REASON> {
    ...
    interface Err<RESULT, REASON> extends _Result<RESULT, REASON> {
        readonly isOk: false;
    ...
    interface Async<SUCCESS, FAILURE> {
        ...
        /**
         * A function that notifies the consuming function of the loading state.
         *
         ...
         * */
        readonly onLoading: (consumer: Consumer<boolean>) => Async<SUCCESS, FAILURE>;
